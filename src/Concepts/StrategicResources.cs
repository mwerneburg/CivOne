...
namespace CivOne.Concepts
{
	...
	internal class StrategicResources : BaseConcept
	{
		...
		private static readonly string[] _page2 =
		{
			...
			"OIL: Armor, Fighter, Bomber, Cruiser,",
			"Battleship, Submarine, Carrier,",
			"Transport.",
			"",
			"The penalty falls only on the",
			"industrial age, never an early one.",
			"",
			"Mine the tile you work, camp the",
			"tile you don't — a camp earns its",
			"keep where no citizen stands.",
			"",
			"Camps change hands by occupation:",
			"stand a unit on a rival's camp and",
			"it is yours. Flags, not ashes.",
		};
