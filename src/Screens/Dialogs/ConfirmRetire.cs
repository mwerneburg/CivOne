...
{
	[OwnPalette]
	internal class ConfirmRetire : BaseScreen
	{
		...
		protected override bool HasUpdate(uint gameTick)
		{
			...
			this.DrawText("RETIRE", 0, CassetteTheme.PHOS, px + pw / 2, py + 4, TextAlign.Center);

			int fh = Resources.GetFontHeight(0);
			this.DrawText("Do you wish to retire, " + Human.LeaderName + "?", 0, CassetteTheme.INK_HIGH,
				px + 5, py + 22, TextAlign.Left);

			this.DrawText("Y / ENTER - RETIRE", 0, CassetteTheme.ALERT,
		...
		public override bool KeyDown(KeyboardEventArgs args)
		{
			...
			{
				Destroy();
				GameTask.Enqueue(Turn.GameOver(Human));
				return true;
			}
			return false;
		}
		...
		public ConfirmRetire() : base(MouseCursor.Pointer)
		{
