...
namespace CivOne.Screens
{
	internal class OlvirArrivalTransmission : TerminalScreen
	{
		...
		private static string[] PreparedDetails(VisitorArchetype archetype, string landfallYear) => archetype switch
		{
			...
			{
				"VESSEL CLASS: CONSTRUCT — INSTRUMENT ARRAYS ON EVERY SURFACE.",
				"POPULATION: NONE DETECTED. IT IS NOT CREWED. IT IS AN INSTRUMENT.",
				"COMMUNICATION: AUTOMATED. REPLIES ARRIVE AS PRE-FORMED NOTICES.",
				"",
				"FIRST TRANSMISSION (TRANSLATED):",
				...
				"",
				"ASSESSMENT: IT IS NOT LANDING. IT IS WATCHING ALL OF US AT ONCE.",
				"ASSESSMENT: THIS IS A TEST WE DID NOT KNOW WE WERE TAKING.",
				"ASSESSMENT: IT GRADES THE SPECIES. NO NATION IS GRADED ALONE.",
			},
